...
Haskell implementation of BOLT #1 (Lightning Network base protocol).

Specification: https://github.com/lightning/bolts/blob/master/01-messaging.md

## Project Structure

- `lib/` - library source (Lightning.Protocol.BOLT1)
